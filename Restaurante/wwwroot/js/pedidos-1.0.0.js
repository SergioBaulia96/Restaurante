...
function ListadoPedidos()
{
    $.ajax({
        ...
        success: function(listadoPedidos){
            ...
            tabla += `
            <tr>
                <td style="text-align: center;">${pedidos.nombreCliente}</td>
                <td style="text-align: center;">${pedidos.nombreMesero}</td>
                <td style="text-align: center;">${pedidos.numeroMesa}</td>
                <td style="text-align: center;">${pedidos.fechaPedido}</td>
                <td style="text-align: center;">${pedidos.estado}</td>
                <td style="text-align: center;">${pedidos.total}</td>
...
function ModalEditar(PedidoID){
    $.ajax({
        ...
        success: function(listadoPedidos){
            ...
            document.getElementById("FechaPedido").value = listadoPlato.fechaPedido;
